...
public class ProfileService {
    ...
    /**
     * Orchestrates the creation of a new profile.
     * Generates the ID here so the service (business logic) owns the identity,
     * not the database.
     */
    ...
    /**
     * Handles the lookup logic.
     * Note: We use a custom exception here so the REST layer
     * can map it to a 404 automatically.
     */
